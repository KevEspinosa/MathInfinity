...
import { GameMaestroStyles } from './GameMaestroStyles';
...
const GameNovato = ({ navigation }: any) => {
    ...
    const [timeSeconds, changeTimeSeconds] = React.useState<number>(120);
    ...
    const onPressAnswer = (value: number) => {
        if (value === answers[currentAnswer].result) {
            ...
            changeTimeSeconds(timeSeconds + 4);
        }
    }
    ...
    return (
        <View style={GameMaestroStyles.HomeContainer}>
            <TouchableOpacity
                style={GameMaestroStyles.headerContainer}
                onPress={() => navigation.navigate('Home')}>
                <Image source={require('../../../images/icons/arrow.png')} style={GameMaestroStyles.menuIcon} />
                <Text style={GameMaestroStyles.headerTitle}>Maestro</Text>
            </TouchableOpacity>
            <View style={GameMaestroStyles.HomeContainer}>
                ...
                <View style={{ flexDirection: 'row', flex: 0.8, alignItems: 'flex-end' }}>
                    <View style={{ flexDirection: 'column', flex: 0.8, height: 150 }}>
                        <View style={GameMaestroStyles.OptionBotton}>

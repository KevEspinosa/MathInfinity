...
import { GameVeteranoStyles } from './GameVeteranoStyles';
...
const GameNovato = ({ navigation }: any) => {
    ...
    const [timeSeconds, changeTimeSeconds] = React.useState<number>(240);
    ...
    const onPressAnswer = (value: number) => {
        if (value === answers[currentAnswer].result) {
            ...
            changeTimeSeconds(timeSeconds + 6);
        }
    }
    ...
    const onPressIncorrectAnswer = (value: number) => {
        if (value === answers[currentIncorrectAnswer].result) {
            ...
            changeTimeSeconds(timeSeconds - 10);
        }
    }
    ...
    return (
        <View style={GameVeteranoStyles.HomeContainer}>
            <TouchableOpacity
                style={GameVeteranoStyles.headerContainer}
                onPress={() => navigation.navigate('Home')}>
                <Image source={require('../../../images/icons/arrow.png')} style={GameVeteranoStyles.menuIcon} />
                <Text style={GameVeteranoStyles.headerTitle}>Veterano</Text>
            </TouchableOpacity>
            ...
            <View style={GameVeteranoStyles.HomeContainer}>
                ...
                <View style={{ flexDirection: 'row', flex: 0.8, alignItems: 'flex-end' }}>
                    <View style={{ flexDirection: 'column', flex: 0.8, height: 150 }}>
                        <View style={GameVeteranoStyles.OptionBotton}>
